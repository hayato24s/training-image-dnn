...
from common.layers import AveragePooling, Convolution, LayerNormalization, Linear
from common.layers.relu import Relu
from common.layers.softmax_with_loss import SoftmaxWithLoss
from common.np import np
from model.lenet_with_norm.norm_and_relu import NormAndRelu


class LenetWithNorm(BaseModel):
    """
    Architecture
    ------------
    - Convolution
    ...
    def predict(self, x: np.ndarray) -> np.ndarray:
        ...
        x = self.norm_and_relu3.forward(x)
    ...
    def backward(self) -> np.ndarray:
        ...
        dout = self.norm_and_relu3.backward(dout)
